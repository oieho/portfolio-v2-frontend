        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://3.38.232.173:8088/oauth2/authorization/kakao?redirect_uri=http://3.38.232.173:3000/socialLogin')
              }
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://3.38.232.173:8088/oauth2/authorization/naver?redirect_uri=http://3.38.232.173:3000/socialLogin')
              }
            ...
            <GoogleBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://3.38.232.173:8088/oauth2/authorization/google?redirect_uri=http://3.38.232.173:3000/socialLogin')
              }
