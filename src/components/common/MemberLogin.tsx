        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://54.180.58.152:8088/api/oauth2/authorization/kakao?redirect_uri=http://54.180.58.152:3000/socialLogin')
              }
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://54.180.58.152:8088/api/oauth2/authorization/naver?redirect_uri=http://54.180.58.152:3000/socialLogin')
              }
            ...
            <GoogleBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://ec2-54-180-58-152.ap-northeast-2.compute.amazonaws.com:8088/api/oauth2/authorization/google?redirect_uri=http://54.180.58.152:3000/socialLogin')
              }
