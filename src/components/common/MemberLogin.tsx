        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://172.17.0.4:8088/oauth2/authorization/kakao?redirect_uri=http://172.17.0.4:3000/socialLogin')
              }
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://172.17.0.4:8088/oauth2/authorization/naver?redirect_uri=http://172.17.0.4:3000/socialLogin')
              }
            ...
            <GoogleBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://172.17.0.4:8088/oauth2/authorization/google?redirect_uri=http://172.17.0.4:3000/socialLogin')
              }
