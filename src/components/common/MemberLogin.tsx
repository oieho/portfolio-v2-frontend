        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://port-0-portfolio-v2-backend-3prof2lll3bfr1i.sel3.cloudtype.app/oauth2/authorization/kakao?redirect_uri=http://web-portfolio-v2-frontend-3prof2lll3bfr1i.sel3.cloudtype.app/socialLogin')
              }
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://port-0-portfolio-v2-backend-3prof2lll3bfr1i.sel3.cloudtype.app/oauth2/authorization/naver?redirect_uri=http://web-portfolio-v2-frontend-3prof2lll3bfr1i.sel3.cloudtype.app/socialLogin')
              }
