        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://host.docker.internal:8088/oauth2/authorization/kakao?redirect_uri=http://host.docker.internal:3000/socialLogin')
              }
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://host.docker.internal:8088/oauth2/authorization/naver?redirect_uri=http://host.docker.internal:3000/socialLogin')
              }
            ...
            <GoogleBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://host.docker.internal:8088/oauth2/authorization/google?redirect_uri=http://host.docker.internal:3000/socialLogin')
              }
