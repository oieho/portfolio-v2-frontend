            ...
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'https://port-0-portfolio-v2-backend-3prof2lll3bfr1i.sel3.cloudtype.app/oauth2/authorization/kakao?redirect_uri=https://portfolio-v2-frontend:80/#/socialLogin')
              }
