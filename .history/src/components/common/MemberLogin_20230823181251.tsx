            ...
            <KakaoBtnWrap
              onClick={() =>
                (window.location.href =
                  'http://port-0-portfolio-v2-backend-3prof2lll3bfr1i.sel3.cloudtype.app/oauth2/authorization/kakao?redirect_uri=https://nginx-nginx-3prof2lll3bfr1i.sel3.cloudtype.app/#/socialLogin')
              }
