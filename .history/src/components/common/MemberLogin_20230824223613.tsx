        ...
        <Description ref={LoginRef}>
          ...
          <AlignBtn>
            ...
            <NaverBtnWrap
              onClick={() =>
                (window.location.href =
                  'https://portfolio-v2-backend-production.up.railway.app/oauth2/authorization/naver?redirect_uri=https://oieho.xyz/socialLogin')
              }
            ...
            <GoogleBtnWrap
              onClick={() =>
                (window.location.href =
                  'https://portfolio-v2-backend-production.up.railway.app/oauth2/authorization/google?redirect_uri=https://oieho.xyz/socialLogin')
              }
