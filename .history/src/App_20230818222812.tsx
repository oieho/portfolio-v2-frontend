...
const App = () => {
  return (
    <>
      ...
      <HashRouter>
        <Routes>
          <Route path="/" element={<Main />} /> {/* 기본 경로에 대한 설정 */}
          <Route path="/boards/view/:wno" element={<ContentBody />} />
          <Route path="/boards/write" element={<ContentBodyOnWriting />} />
          <Route
            path="/boards/modify/:wno"
            element={<ContentBodyOnModifing />}
          />
